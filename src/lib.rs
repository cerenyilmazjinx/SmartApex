...
#[derive(Debug)]
pub struct SmartApexProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SmartApexProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SmartApex processing");
    
    let mut processor = SmartApexProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SmartApexProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SmartApexProcessor::new(false);
